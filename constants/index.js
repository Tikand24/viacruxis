export const startingFeatures = [
  'Persinarze, Oracion inicial que se repite en cada estacion.',
  'Lectura y reflexion de cada estacion',
  'Padre nuestro, avemaria y gloria',
];

export const stationList = [
  {
    title: '1ª Estación: Jesús sentenciado a muerte',
    description: [
      `«Reo es de muerte», dijeron de Jesús los miembros del Sanedrín, y,
      como no podían ejecutar a nadie, lo llevaron de la casa de Caifás al
      Pretorio. Pilato no encontraba razones para condenar a Jesús, e
      incluso trató de liberarlo, pero, ante la presión amenazante del
      pueblo instigado por sus jefes: «¡Crucifícalo, crucifícalo!», «Si
      sueltas a ése, no eres amigo del César», pronunció la sentencia que le
      reclamaban y les entregó a Jesús, después de azotarlo, para que fuera
      crucificado.`,
  ...
  {
    title: '2ª Estación: Jesús cargado con la cruz',
    description: [
  ...
  {
    title: '3ª Estación: Jesús cae, por primera vez, bajo el paso de la cruz',
    description: [
  ...
  {
    title: '4ª Estación: Encuentro con la Virgen',
    description: [
  ...
  {
    title: '5ª Estación: el Cirineo ayuda al Señor a llevar la Cruz',
    description: [
  ...
  {
    title: '6ª Estación: la Verónica enjuga el rostro de Jesús',
    description: [
  ...
  {
    title: '7ª Estación: Segunda caída en el camino de la Cruz',
    description: [
  ...
  {
    title: '8ª Estación: Jesús consuela a las hijas de Jerusalén',
    description: [
  ...
  {
    title: '9ª Estación: Jesús cae por tercera vez',
    description: [
  ...
  {
    title: '10ª Estación: Jesús despojado de sus vestiduras',
    description: [
  ...
  {
    title: '11ª Estación: Jesús es clavado en la Cruz',
    description: [
  ...
  {
    title: '12ª Estación: Jesús muere en la Cruz',
    description: [
  ...
  {
    title: '13ª Estación: Jesús en brazos de su madre',
    description: [
  ...
  {
    title: '14ª Estación: Jesús puesto en el sepulcro',
    description: [
